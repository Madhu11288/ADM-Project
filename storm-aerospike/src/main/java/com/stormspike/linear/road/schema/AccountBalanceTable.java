...
public class AccountBalanceTable {
    ...
    public void updateAccountBalance(String vehicleID,float tollCost) {
        ...
        if (this.client.exists(this.writePolicy, key)) {
            ...
            Bin bin1 = new Bin(Constants.ACCOUNT_BALANCE_BIN, accountBalance);
            this.client.put(writePolicy, key, bin1);
        }
    }
}

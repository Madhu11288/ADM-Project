    ...
    public void execute(Tuple input) {
        ...
        if (!jedis.exists(vehiclePositionReportKey)) {
            ...
            if (!storedValues.get(0).equals(xWay) || !storedValues.get(1).equals(lane)
                ...
                String vehiclesPreviousSegmentKey = "report:minute:" + storedValues.get(4) + ":xWay:" + storedValues.get(1)
                        + ":lane:" + storedValues.get(1) + ":direction:" + storedValues.get(2) + ":segment:"
                        + storedValues.get(3);
                jedis.lrem(vehiclesPreviousSegmentKey, 0, "avg-speed:minute:" + storedValues.get(4)
